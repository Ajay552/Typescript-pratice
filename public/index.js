...
console.log(person);
// explicit types
let char = "This is a string"; //only string
let age = 25; //only number i.e int and float
let isSet = true; // only true or false
...
uid = "hello";
// objects
let person1; // this will work for array also because array is an object type
